...
const SIGN_OUT_ENDPOINT = '/users/loguot';
...
const signOut = createAsyncThunk('auth/signOut', async (__, thunkAPI) => {
  try {
...
const getUser = createAsyncThunk('auth/getUser', async (__, thunkAPI) => {
